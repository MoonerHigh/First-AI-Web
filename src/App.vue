  ...
  <div class="relative h-screen">
    <div class="py-10 lg:py-14">
      ...
      <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
        ...
        <p class="mt-3 text-gray-600">Your AI-powered copilot for the web</p>
      </div>
      <!-- End Title -->
      ...
      <ul class="mt-16 space-y-5">
          ...
          <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              ...
              <div class="grow mt-2 space-y-3">
                <p class="text-gray-800">what's preline ui?</p>
              </div>
            </div>
          </div>
        </li>
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            ...
            <div>
              <div class="sm:flex sm:justify-between">
                <div>
                  <div
                    class="inline-flex border border-gray-200 rounded-full p-0.5"
                  >
                    <button
                      type="button"
                      class="inline-flex flex-shrink-0 justify-center items-center size-8 rounded-full text-gray-500 hover:bg-blue-100 hover:text-blue-800 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                      <svg
        ...
        <li class="py-2 sm:py-4">
          <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              ...
              <div class="grow mt-2 space-y-3">
                <p class="text-gray-800">what's preline ui figma?</p>
                <div class="mt-3">
                  <button
                    type="button"
                    class="p-2 inline-flex items-center gap-x-2 text-xs font-semibold rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
                  >
                    <svg
                      class="flex-shrink-0 size-4"
                      xmlns="http://www.w3.org/2000/svg"
        ...
        >
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            ...
            <div class="space-y-3">
              ...
              <div class="space-y-1.5">
                <p class="text-sm text-gray-800">With the features like:</p>
                <ul class="list-disc list-outside space-y-1.5 ps-3.5">
                  <li class="text-sm text-gray-800">12-column Grid System</li>

                  <li class="text-sm text-gray-800">Easily find UI elements</li>

                  <li class="text-sm text-gray-800">Variants and Properties</li>
        ...
        >
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            <!-- Card -->
            <div class="space-y-3">
              <p class="text-sm text-gray-800">Hold on a sec...</p>
            </div>
            <!-- End Card -->
                      ...
                      <tr>
                        <td class="size-px whitespace-nowrap">
                          <div class="px-6 py-3">
                            <div class="flex items-center gap-x-3">
                              <span
                                class="inline-flex items-center justify-center size-[38px] rounded-full bg-gray-300"
                              >
                                <span
                                  class="font-medium text-gray-800 leading-none"
                                  >A</span
                                >
                              </span>
                              <div class="grow">
        ...
        <li class="py-2 sm:py-4">
          <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              ...
              <div class="grow mt-2 space-y-3">
                <p class="text-gray-800">show me the code</p>
              </div>
            </div>
          </div>
        </li>
        ...
        >
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            <!-- Card -->
            <div class="space-y-3">
              <p class="text-sm text-gray-800">Of course!</p>
            </div>
            <!-- End Card -->

            <div
              class="mt-3 flex-none min-w-full bg-gray-800 font-mono text-sm p-5 rounded-lg"
            >
              <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                  <tr>
        ...
        <li class="py-2 sm:py-4">
          <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              ...
              <div class="grow mt-2 space-y-3">
                <p class="text-gray-800">quiz me about tailwindcss</p>
              </div>
            </div>
          </div>
        </li>
        ...
        >
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            <!-- Card -->
            <div class="space-y-3">
              <p class="text-sm text-gray-800">Sure!</p>
            </div>
            <!-- End Card -->
            ...
            <div>
              <button
                type="button"
                class="mb-2.5 me-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-lg border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 text-sm"
              >
        ...
        >
          ...
          <div class="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
            <!-- Card -->
            <div class="space-y-3">
              <p class="text-sm text-gray-800">Here you go...</p>
            </div>
            <!-- End Card -->
        ...
        <li class="py-2 sm:py-4">
          <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              ...
              <div class="grow mt-2 space-y-3">
                <p class="text-gray-800">what's tailwindcss?</p>
              </div>
            </div>
          </div>
        </li>
            ...
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              <div>
                <div class="text-end">
                  <button
                    type="button"
                    class="ms-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-lg border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 text-sm"
                  >
        ...
        <li class="py-2 sm:py-4">
          <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="max-w-2xl flex gap-x-2 sm:gap-x-4">
              ...
              <div class="grow mt-2 space-y-3">
                <p class="text-gray-800">2 files uploaded</p>

                <ul class="flex flex-col justify-end text-start -space-y-px">
                  <li
                    class="flex items-center gap-x-2 p-3 text-sm bg-white border text-gray-800 first:rounded-t-lg first:mt-0 last:rounded-b-lg"
                  >
                    <div class="w-full flex justify-between truncate">
                      ...
                      <button
                        type="button"
                        class="flex items-center gap-x-2 text-gray-500 hover:text-blue-600 whitespace-nowrap"
                      >
                        <svg
                          class="flex-shrink-0 size-4"
                          xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Search -->
    <footer
      class="sticky bottom-0 z-10 bg-white border-t border-gray-200 pt-2 pb-3 sm:pt-4 sm:pb-6"
    >
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center mb-3">
          <button
            type="button"
            class="inline-flex justify-center items-center gap-x-2 rounded-lg font-medium text-gray-800 hover:text-blue-600 text-xs sm:text-sm"
          >
            <svg
              class="flex-shrink-0 size-4"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <button
            type="button"
            class="py-1.5 px-2 inline-flex items-center gap-x-2 text-xs font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
          >
            <svg
              class="size-3"
              xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="absolute bottom-px inset-x-px p-2 rounded-b-md bg-white">
            <div class="flex justify-between items-center">
              ...
              <div class="flex items-center">
                ...
                <button
                  type="button"
                  class="inline-flex flex-shrink-0 justify-center items-center size-8 rounded-lg text-gray-500 hover:text-blue-600 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  <svg
                    class="flex-shrink-0 size-4"
                    xmlns="http://www.w3.org/2000/svg"
